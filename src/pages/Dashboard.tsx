        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12 animate-slide-up">
          ...
          <div className="space-y-8 animate-scale-in">
            <Card className="p-6 shadow-card bg-gradient-faith text-white hover-lift">
              ...
              <p className="font-semibold mt-3">Dias Consecutivos</p>
            ...
            <Card className="p-6 shadow-card bg-gradient-growth text-white hover-lift">
              ...
              <p className="font-semibold mt-3">Dias de Leitura</p>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12 items-start"> {/* Adicionado items-start para corrigir o alinhamento */}
          <Card className={`lg:col-span-2 p-8 shadow-card border-2 ${isCompleted ? 'border-success/50 bg-success/5' : 'border-primary/20'}`}>
            ...
            <div className="space-y-6 mb-8">
              <div className="p-6 bg-blue-50 dark:bg-blue-950/30 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="p-6 bg-purple-50 dark:bg-purple-950/30 rounded-lg border-l-4 border-purple-500">
                <div className="flex items-center gap-2 mb-3">
